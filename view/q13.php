...
<form class="surveyForm">
    <table class="surveyTable" ng-repeat="input in answers[0].q13">
        <tbody>
            ...
            <tr>
                <td><input ng-model="health.result" name="exercise" type="radio" value="{{ health.rate }}" ></td>
            ...
            <tr>
                <td><input ng-model="health.result" name="exercise" type="radio" value="{{ $eval(health.rate) - 5 }}" ></td>

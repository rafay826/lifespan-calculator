...
<html ng-app="surveyApp">
    <head>
        ...
        <!--------CSS---------->
        <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>/projects/lifespan-calculator/css/style.css">
        ...
        <script src="<?php echo ROOT_PATH; ?>/projects/lifespan-calculator/js/app.js"></script>
        <script src="<?php echo ROOT_PATH; ?>/projects/lifespan-calculator/js/controllers.js"></script>
